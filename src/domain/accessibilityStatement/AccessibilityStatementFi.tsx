  ...
  return (
    <>
      ...
      <p>
        ...
        http://kummilapset.hel.fi/.
      </p>
      <h2>Sivustoa koskevat lain säädökset</h2>
      <p>
        Tämä sivusto on julkaistu <time dateTime="2018-09-23">23.9.2018</time>{' '}
        jälkeen. Sivuston tulee täyttää lain edellyttämät saavutettavuuden
        vaatimukset.
      </p>
      ...
      <p>
        Tämä seloste on laadittu <time dateTime="2020-03-23">23.03.2020</time>{' '}
        ja päivitetty <time dateTime="2020-09-09">09.09.2020</time>
      </p>
      ...
      <p>
        ...
        viestintä, puhelinvaihde <a href="tel:09 310 1060">09 310 1060</a>.
      </p>
      <p>
      ...
      <p>
        ...
        ilmoitetuista neuvontasivuilta sekä puhelinneuvonnasta.
      </p>
      <p>
        <strong>Neuvontaa Helsingin kaupungin palveluista</strong>
        <br />
        Puhelinneuvonta: <a href="tel:0931011111">09 310 11 111</a>
        <br />
        Avoinna: ma–to klo 9–16 ja pe klo 10–15
        <br />
        <a href="https://www.hel.fi/helsinki/fi/kaupunki-ja-hallinto/hallinto/viestinta/viestinta-ja-neuvonta">
          Siirry kaupungin neuvontasivuille
        </a>
      </p>
      <h2>Saavutettavuusselosteen hyväksyntä</h2>
      <p>
        Tämän selosteen on hyväksynyt{' '}
        <time dateTime="2020-09-09">9.9.2020</time>
      </p>
      <p>
        Kulttuurin ja vapaa-ajan toimiala
        <br />
